    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        {daysDiff > 30 && daysDiff <= MAX_DAYS && (
          <p className="mt-2 text-xs text-amber-700 dark:text-amber-400">
            Merk: perioder over 30 dager kan ta for lang tid og gi timeout. Anbefaler maks 30 dager.
          </p>
        )}
      </div>
      ...
      <div>
        <label className="block text-sm font-medium text-slate-700 dark:text-slate-200 mb-1">
          ...
          <span
            ...
            style={{ animation: "value-pop 0.4s cubic-bezier(0.34, 1.56, 0.64, 1) both" }}
          >
            {minDelay} min
          </span>
        </label>
      ...
      <div className="flex gap-3">
        <button
          ...
          style={isValid && !isLoading ? { animation: "glow-pulse 2.5s ease-in-out infinite" } : undefined}
        >
