...
export default function ResultsTable({
  ...
  if (error) {
    return (
      <div
        ...
        style={{
          animation:
            "shake 0.35s ease-in-out, section-enter 0.3s ease-out both",
        }}
      >
  ...
  const rowAnimationIndex = new Map(
    dates
      ...
      .map((row, i) => [row.datedServiceJourneyId, i]),
  );
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            style={{
              animation:
                "pop-in 0.4s cubic-bezier(0.34, 1.56, 0.64, 1) 0.05s both",
            }}
          >
            <ChartIcon />
            Graf per dag
          ...
          <button
            ...
            style={{
              animation:
                "pop-in 0.4s cubic-bezier(0.34, 1.56, 0.64, 1) 0.1s both",
            }}
          >
            <ChartIcon />
            Graf per time
